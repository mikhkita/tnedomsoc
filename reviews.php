...
<body>
	...
	<div class="b b-navigation">
		<ul class="b-block clearfix">
			...
			<li class="active"><a href="#" onclick="return false;">Отзывы</a></li>
		</ul>
	</div>
	<div class="b-other-content">
		<div class="b-block">
			<div class="contacts-cont">
				<h2 class="title">отзывы наши клиенты</h2>
				<div class="b-text">
					<p>Главная цель наших клиник&nbsp;&mdash; предложить вам самое лучшее, что есть сегодня в&nbsp;современной стоматологии. Наша ежедневная работа&nbsp;&mdash; оказание качественной стоматологической помощи по&nbsp;передовыми международными стандартами.</p>
					<p>За&nbsp;10 лет работы мы&nbsp;приняли больше 40000 пациентов. Мы&nbsp;получаем множество благодарностей, вы&nbsp;рекомендуете нашу клинику своим друзьям и&nbsp;знакомым. Это говорит о&nbsp;том, что вы&nbsp;нам доверяете. Спасибо вам! И&nbsp;вместе с&nbsp;тем мы&nbsp;очень ценим советы и&nbsp;конструктивную критику.</p>
