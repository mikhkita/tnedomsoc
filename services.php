...
<body>
	...
	<div class="b b-navigation">
		<ul class="b-block clearfix">
			...
			<li class="active"><a href="#" onclick="return false;">Услуги</a></li>
		</ul>
	</div>
	...
	<div class="b b-about-cosm b-grey">
		<div class="b-block">
			<div class="b-text">
				<p>COSMODENT&nbsp;&mdash; это идеальные стоматологические клиники для современного жителя Москвы. Того, у&nbsp;которого вечно не&nbsp;хватает времени на&nbsp;себя, кто немного побаивается визитов к&nbsp;зубному и, может быть, не&nbsp;всегда выполняет все предписания врача. У&nbsp;нас вам будет комфортно: вам обязательно вовремя напомнят о&nbsp;предстоящем визите, объяснят сущность каждой процедуры, а&nbsp;главное&nbsp;&mdash; сделают все для того, чтобы вы&nbsp;как можно реже садились в&nbsp;стоматологическое кресло для лечения. А&nbsp;еще&nbsp;&mdash; наши доктора будут обходиться с&nbsp;вами также нежно и&nbsp;аккуратно, как с&nbsp;ребенком!</p>
