...
<body>
	...
	<div class="b b-what">
		<div class="b-block clearfix">
			<div class="right text">
				...
				<a href="#" class="link with-arrow">Читать полностью</a>
			</div>
		...
		<div class="b-block slider-cont">
			<div>
				<div>
					...
					<ul>
						<li>Лучшее стоматологиеческое оборудование из Европы.</li>
						<li>Лечение зубов пациентам по самым современным мировым стандартам.</li>
					</ul>
					<p>Лечение кариеса и&nbsp;пульпита с&nbsp;использованием микроскопа, точнейшее протезирование и&nbsp;реставрация лучшими материалами.</p>
				...
				<li class="gigienist-1" style="background-image: url('i/doctor-1.jpg');">
					<a class="desc-cont" href="#">
						<div class="b-mobile-bottom">
							<h3>Куркина Аленаasdas Евгеньевна</h3>
							<h4>
								Хирург-стоматолог,
								имплантолог,
								пародонтолог
							</h4>
							<h5 class="with-arrow fancy" data-block="#b-popup-rec" data-name="1" data-spec="1">Записаться на прием</h5>
						</div>
					</a>
				</li>
	...
	<div style="display:none;">
		<div id="b-popup-rec">
			<div class="b-popup">
				...
				<form action="kitsend.php" method="POST" id="b-form-1" data-block="#b-popup-2">
					...
					<select class="input" name="doctor-name" id="name-select" required>
						<option value="default" selected disabled>Выберите доктора</option>
						<option data-prof="Гигиенист стоматологический" value="Куркина Алена Евгеньевна">Куркина Алена Евгеньевна</option>
						<option data-prof="Ортодонт" value="Гурген Хачатрян">Гурген Хачатрян</option>
					</select>
		...
		<select class="input" name="doctor-name" id="name-clone" required>
			<option value="default" selected disabled>Выберите доктора</option>
		</select>
